...
# bashdb - this is a bash debugger
# Driver Script - concatenates premble and the target script
# and then this executes a new script
...
_tmpdir=/tmp
_libdir=.
_debugfile=$_tmpdir/bashdb.$$ #this is a temporary script that is being debugged
...
# $3 = the directory where dashdb.pre and bashdb.fns are stored
...
# Set a breakpoint at the given line number or list of breakpoints
function _setbp
{
    local i
